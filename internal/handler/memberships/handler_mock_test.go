...
import (
	...
	memberships "github.com/hilmiikhsan/music-catalog/internal/models/memberships"
...
func (m *Mockservice) SignUp(req memberships.SignUpRequest) error {
	m.ctrl.T.Helper()
...
func (mr *MockserviceMockRecorder) SignUp(req any) *gomock.Call {
